            ...
            <div class="container">
                ...
                <form class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <p class="form-control" name="status" id="status">
                                <c:if test="${requestScope['users'].getStatus() == '1'}">Đang hoạt động</c:if>
                                <c:if test="${requestScope['users'].getStatus() == '2'}">Đã nghỉ</c:if>
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <p class="form-control" name="roleid" id="roleid">
                                <c:if test="${requestScope['users'].getRoleId() == '1'}">Admin</c:if>
                                <c:if test="${requestScope['users'].getRoleId() == '2'}">Người dùng</c:if>
                            </p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            ...
                            <button type="submit" class="btn btn-primary"> <i class="far fa-trash-alt"></i> Xoá tài khoản</button>
